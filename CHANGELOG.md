...
- Due to various circumstances, the CoreS3 version is not available on M5Burner. Please download it from GitHub.
...
- バージョン情報を設定に追加しました。
- 諸事情により、CoreS3バージョンはM5Burnerで提供できません。GitHubからダウンロードしてください。
